...
func (g *goLoggingLogger) Debugf(s string, i ...interface{}) {
	g.log.Debugf(s, i...)
}

func (g *goLoggingLogger) Infof(s string, i ...interface{}) {
	g.log.Infof(s, i...)
}

func (g *goLoggingLogger) Warnf(s string, i ...interface{}) {
	g.log.Warningf(s, i...)
}

func (g *goLoggingLogger) Errorf(s string, i ...interface{}) {
	g.log.Errorf(s, i...)
}

func (g *goLoggingLogger) Fatalf(s string, i ...interface{}) {
	g.log.Fatalf(s, i...)
}
